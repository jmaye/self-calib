...
and amplitudes from $0$ [m] to $5$ [m] with steps of $0.5$ [m] over $3000$
timesteps. Fig.~\ref{fig:sine-wave-analysis} displays the result of this
experiment.

\begin{figure*}[t]
\centering
\includegraphics[width=1.9\columnwidth]{fig/sine-wave-analysis.eps}
\caption{Sine wave results.}
