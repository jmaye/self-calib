...
induces storage of uninformative measurements\todo{Should we show that?}, a small $k$ leads to useless
...
$\lambda=0.5\;\text{[bits]}$ in our experiments.
...
and not from some subjective prior information that could bias the inference.\todo{Maybe more on that?}
