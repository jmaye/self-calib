...
% range finder with known calibration parameters. A prior on the first pose
% can be added to make the problem full rank.

function [x_est l_est] = ls_slam_prior(Theta, x_hat, l_hat, u, r, b, t, Q, ...
  R, maxIter, optTol, x0, P0)
