...
for i = 1:nl
  ...
  Fx(2, 2) = 1;
  if numCalib < 3
    x(1, 4 + (i - 1) * 2) = x(1, 1) + Theta_0(1) * cos(x(1, 3)) + r(2, i) *...
      cos(b(2, i) + x(1, 3));
    x(1, 4 + (i - 1) * 2 + 1) = x(1, 2) + Theta_0(1) * sin(x(1, 3)) +...
      r(2, i) * sin(b(2, i) + x(1, 3));
    Fx(1, 3) = -Theta_0(1) * sin(x(1, 3)) - r(2, i) * sin(x(1, 3) + b(2, i));
    Fx(2, 3) = Theta_0(1) * cos(x(1, 3)) + r(2, i) * cos(x(1, 3) + b(2, i));
    Fy(1, 1) = cos(x(1, 3) + b(2, i));
    Fy(1, 2) = -r(2, i) * sin(b(2, i) + x(1, 3));
    Fy(2, 1) = sin(b(2, i) + x(1, 3));
    Fy(2, 2) = -r(2, i) * cos(b(2, i) + x(1, 3));
  else
    x(1, 4 + (i - 1) * 2)  = x(1, 1) + Theta_0(1) * cos(x(1, 3)) -...
      Theta_0(2) * sin(x(1, 3)) + r(2, i) * cos(b(2, i) + Theta_0(3) + x(1, 3));
    x(1, 4 + (i - 1) * 2 + 1) = x(1, 2) + Theta_0(1) * sin(x(1, 3)) +...
      Theta_0(2) * cos(x(1, 3)) + r(2, i) * sin(b(2, i) + Theta_0(3) + x(1, 3));
    Fx(1, 3) = -Theta_0(1) * sin(x(1, 3)) - Theta_0(2) * cos(x(1, 3)) -...
      r(2, i) * sin(x(1, 3) + b(2, i) + Theta_0(3));
    Fx(2, 3) = Theta_0(1) * cos(x(1, 3)) - Theta_0(2) * sin(x(1, 3)) +...
      r(2, i) * cos(x(1, 3) + b(2, i) + Theta_0(3));
    Fy(1, 1) = cos(x(1, 3) + b(2, i) + Theta_0(3));
    Fy(1, 2) = -r(2, i) * sin(b(2, i) + x(1, 3) + Theta_0(3));
    Fy(2, 1) = sin(b(2, i) + x(1, 3) + Theta_0(3));
    Fy(2, 2) = -r(2, i) * cos(b(2, i) + x(1, 3) + Theta_0(3));
  end
  P(4 + (i - 1) * 2:4 + (i - 1) * 2 + 1, ...
    4 + (i - 1) * 2:4 + (i - 1) * 2 + 1, 1) =...
