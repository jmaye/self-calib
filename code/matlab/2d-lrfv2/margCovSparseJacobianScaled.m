...
function Sigma = margCovSparseJacobianScaled(J, i, epstol)
...
JThetaTrans = (J_theta * G_theta)' * J_theta * G_theta - J_thetatQ * J_thetatQ';
...
Sigma = G_theta * P * spqr_qmult(Q, invR, 2) * G_theta;
